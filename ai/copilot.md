...
- Use `async/await` only and explicit actionable error handling for failure paths.
- Include test updates for behavior changes.
- If `npm run check` fails on TypeScript errors, update code to satisfy type safety before finalizing.
