...
All assistant-specific adapter files in `ai/*.md` MUST remain aligned with these rules. Before finalizing code generation, assistants MUST run `npm run check`; if TypeScript errors appear, they MUST fix code and rerun checks.
